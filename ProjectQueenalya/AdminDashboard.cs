...
namespace ProjectQueenalya
{
    public partial class AdminDashboard : Form
    {
        ...
        private void btnPebimbing_Click(object sender, EventArgs e)
        {
            OpenChildForm(new AdminDashboardForm.FormPebimbing(), sender);
        }
        ...
        private void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("UPDATE Login SET status='False' WHERE nama='" + LoginStatus.nama + "' AND role='admin'", connection))
            {
                connection.Open();
                cmd.ExecuteNonQuery();
            }
