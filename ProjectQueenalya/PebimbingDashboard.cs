...
{
    public partial class PebimbingDashboard : Form
    {
        ...
        private void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("UPDATE Login SET status='False' WHERE nama='" + LoginStatus.nama + "' AND role='pembimbing'", connection))
            {
                connection.Open();
                cmd.ExecuteNonQuery();
            }
